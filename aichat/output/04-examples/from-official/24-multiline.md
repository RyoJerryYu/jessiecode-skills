# 多行注释示例 / Multiline Comment Example

## 图形描述

此示例演示 JavaScript/JessieCode 中的作用域链和闭包概念（与 scopechain.html 内容相同）。代码展示了：
- 全局变量的定义和访问
- 函数内部的局部变量
- 嵌套函数对外部变量的访问
- 闭包的创建和使用
...
这是一个关于 JavaScript 核心概念——作用域链和闭包的重要示例，同时展示了多行注释的语法支持。
...
*来源：JessieCode 官方示例 - multiline.html*
