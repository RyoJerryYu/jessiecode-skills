...
| --- | --- |
|  | **[MajorArc](./MajorArc.md#constructor)** |
...
This element has no direct constructor. To create an instance of this element you have to call [JXG.Board#create](./JXG.Board.md#create) with type "majorarc".  
  

Possible parent array combinations are:

{[JXG.Point](../symbols/JXG.Point.html)} **p1** {[JXG.Point](../symbols/JXG.Point.html)} **p2** {[JXG.Point](./JXG.Point.md)} **p3**
:   . Major arc is an arc of a circle around p1 having measure greater than or equal to 180 degrees (pi radians) and starts at p2. The radius is determined by p2, the angle by p3.
