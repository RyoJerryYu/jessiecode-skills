...
| --- | --- |
|  | **[CurveIntersection](./CurveIntersection.md#constructor)** |
...
This element has no direct constructor. To create an instance of this element you have to call [JXG.Board#create](./JXG.Board.md#create) with type "curveintersection".  
  

Possible parent array combinations are:

{[JXG.Curve](../symbols/JXG.Curve.html)|[JXG.Polygon](../symbols/JXG.Polygon.html)|[JXG.Circle](./JXG.Circle.md)} **curve1**
:   First element which is intersected
  
  

{[JXG.Curve](../symbols/JXG.Curve.html)|[JXG.Polygon](../symbols/JXG.Polygon.html)|[JXG.Circle](./JXG.Circle.md)} **curve2**
:   Second element which is intersected
