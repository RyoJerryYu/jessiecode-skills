...
| --- | --- |
|  | **[PerpendicularPoint](./PerpendicularPoint.md#constructor)**  A perpendicular point is given by a point and a line. |
...
This element has no direct constructor. To create an instance of this element you have to call [JXG.Board#create](./JXG.Board.md#create) with type "perpendicularpoint".  
